...
const About = () => {
  ...
  return (
    <div className="about">
       ...
       {/* Header */}
      <header className="lectures-header2 reveal reveal-up">
        <div className="container">
          <div className="header-content2">
            <h1 className="page-title2">
              About <span className="highlight2 reveal reveal-up">Our Institute</span>
            </h1>
            <p className="page-description2 reveal reveal-up">
      ...
      <section className="institute-story reveal reveal-up">
  <div className="container story-grid">
    <div className="story-text-content">
       
            <h2 className="section-title3 reveal reveal-up">
    ...
    <div className="story-image">
      <img src="/assets/c5.jpg" alt="Our Institute" />
    </div>
  </div>
</section>
      ...
      {/* Vision & Mission */}
      <section className="vision-mission reveal reveal-up ">
        <div className="container">
          ...
          <div className="vision-mission-content">
            <div className="vision reveal reveal-left">
              <h3>Our Vision</h3>
              <p>
            ...
            <div className="mission reveal reveal-right">
              <h3>Our Mission</h3>
              <p>
      ...
      <section className="faq reveal reveal-up">
        <div className="container">
          ...
          <div className="faq-content">
            <div className="faq-item reveal reveal-left">
            ...
            <div className="faq-item reveal reveal-right">
