      ...
      <section id="subjects" className="subjects">
        <div className="container">
          ...
          <div className="subjects-grid">
            ...
            <div className="subject-card combined-maths">
              <div className="card-header">
                <div className="subject-icon">📐</div>
            ...
            <div className="subject-card ict">
              <div className="card-header">
                <div className="subject-icon">💻</div>
              ...
              <div className="results-year">
                ...
                <div className="results-grid">
                  <div className="result-card">
                    ...
                    <div className="result-number">98.5%</div>
                ...
                <div className="testimonial-card">
                  ...
                  <div className="testimonial-content">
                    ...
                    <p>
                      ...
                      selected to Faculty of Engineering. Dreams do come true!
                    </p>
                  </div>
                </div>
          ...
          <div className="photo-gallery">
            <div className="gallery-row row-1">
              <div className="photo-item large-photo">
                <img src="src/assets/f.jpg" alt="Main Campus Building" />
              ...
              <div className="photo-column">
                <div className="photo-item">
                  <img src="src/assets/f2.jpg" alt="Physics Laboratory" />
                  <div className="photo-overlay">
                    <h4>Physics Lab</h4>
                  </div>
                </div>
                <div className="photo-item">
                  <img src="src/assets/f4.jpg" alt="Chemistry Laboratory" />
                  <div className="photo-overlay">
                    <h4>Chemistry Lab</h4>
                  </div>
                </div>
            ...
            <div className="gallery-row row-2">
              <div className="photo-item">
                <img src="src/assets/f3.jpg" alt="Library" />
                <div className="photo-overlay">
                  <h4>Digital Library</h4>
                  <p>Extensive collection of A/L resources</p>
                </div>
              </div>
              <div className="photo-item">
                <img src="src/assets/f5.jpg" alt="Computer Lab" />
                <div className="photo-overlay">
                  <h4>ICT Lab</h4>
                  <p>Latest computers and software</p>
                </div>
              </div>
              <div className="photo-item">
                <img src="src/assets/classroom.jpg" alt="Study Hall" />
                <div className="photo-overlay">
                  <h4>Study Hall</h4>
                  <p>Quiet environment for focused learning</p>
                </div>
              </div>
              <div className="photo-item">
                <img src="src/assets/f6.jpg" alt="Auditorium" />
                <div className="photo-overlay">
                  <h4>Auditorium</h4>
                  <p>Special lectures and events</p>
                </div>
              </div>
            </div>
          </div>
